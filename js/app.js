(() => {
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".main-barpage__slider")) new swiper_core_Swiper(".main-barpage__slider", {
                modules: [ Pagination, EffectFade, Autoplay ],
                effect: "fade",
                autoplay: {
                    delay: 2e3,
                ...
                pagination: {
                    el: ".slider-main-barpage__controll",
                    clickable: true
                },
                on: {
                    init: function() {
                        const controll = document.querySelectorAll(".slider-main-barpage__controll .swiper-pagination-bullet");
                        controll.forEach(((el, index) => {
                            let num;
                            if (index < 10) num = `0`;
                            el.innerHTML = `${num}${index + 1}`;
                    ...
                    breakpoint: function(swiper, info) {
                        !info.autoHeight ? document.querySelector(".main-barpage__slider").style.height = "auto" : "";
                        swiper.update();
                    }
                }
            });
        ...
        window.addEventListener("load", (function(e) {
            ...
            if (document.querySelector(".video-module")) {
                document.addEventListener("watcherCallback", (function(e) {
                    const entry = e.detail.entry;
                    const targetElement = entry.target;
                    if (targetElement.dataset.watch === "video" && !targetElement.classList.contains("_init")) if (entry.isIntersecting) ;
                }));
            ...
            const desserts = document.querySelector(".menu-block__link_desserts");
            const food = document.querySelector(".menu-block__link_food");
            const bar = document.querySelector(".menu-block__link_bar");
            const hoverBgFood = document.querySelectorAll(".menu-block__link_food");
            const hoverBgMain = document.querySelector(".menu-block");
            hoverBgFood.forEach((itemBG => {
                itemBG.addEventListener("mouseenter", (function(e) {
                    hoverBgMain.classList.add("_active-food");
                    food.classList.add("_active-food");
                    hoverBgMain.classList.remove("_active-bar");
                    bar.classList.remove("_active-bar");
                    hoverBgMain.classList.remove("_active-desserts");
                    desserts.classList.remove("_active-desserts");
                }));
            }));
            const hoverBgBar = document.querySelectorAll(".menu-block__link_bar");
            hoverBgBar.forEach((itemBG => {
                itemBG.addEventListener("mouseenter", (function(e) {
                    hoverBgMain.classList.add("_active-bar");
                    bar.classList.add("_active-bar");
                    hoverBgMain.classList.remove("_active-food");
                    food.classList.remove("_active-food");
                    hoverBgMain.classList.remove("_active-desserts");
                    desserts.classList.remove("_active-desserts");
                }));
            }));
            const hoverBgDesserts = document.querySelectorAll(".menu-block__link_desserts");
            hoverBgDesserts.forEach((itemBG => {
                itemBG.addEventListener("mouseenter", (function(e) {
                    hoverBgMain.classList.add("_active-desserts");
                    desserts.classList.add("_active-desserts");
                    hoverBgMain.classList.remove("_active-food");
                    food.classList.remove("_active-food");
                    hoverBgMain.classList.remove("_active-bar");
                    bar.classList.remove("_active-bar");
            ...
            window.addEventListener("scroll", (function() {
                topBtn.classList.toggle("_active", window.scrollY > 500);
            }));
